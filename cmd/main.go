...
import (
	...
	"github.com/jrp-enf/license-operator/internal/controller"
...
func main() {
	...
	//	err := leader.Become(context.TODO(), "license-operator-lock")
	//	if err != nil {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d68abc6f.license-operator.enfabrica.net",
